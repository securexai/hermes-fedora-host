...
EXPECTED_HELPER = "32ac4ba34bbff15ecef8869cb32b2e426bd6a9e8ee68b0768bb38e13215ad5dd"
...
def main():
    ...
    if digest != EXPECTED_HELPER:
        sys.exit("Helper hash differs from reviewed S11; stop for review.")
    ...
    run("crypto_policy_path", ["namei", "-l", "/etc/crypto-policies/back-ends/opensshserver.config"])
